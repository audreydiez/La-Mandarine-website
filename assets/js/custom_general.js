...
//*********************Google MAP *********************/
		...
		var color = "#e76f25" // google map background colour
		var saturation = 100 //
		var mapLatitude=45.060436
		var mapLongitude=4.302254//(Fist Value Latitude, Second Value ), get YOUR coordenates here!: http://itouchmap.com/latlong.html
		var mapZoom_value=19 // Map zoom level parameter only numeric


// Google map marker example 2 locations
		//map-marker #1
		var marker1_Latitude=45.060436
		var marker1_Longitude=4.302254
		var marker1_content="<h2>La Mandarine</h2> 2 Route de Tence, 43400 Le Chambon-sur-Lignon" // marker or  on click content (Info Window)
...
jQuery(document).ready(function($){
		...
		/* googleMaps */
				...
				var options = {
				 center: {lat: 45.060439, lng: 4.303057},
